...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs ratherly`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.ratherly` |
| Scheme | `ratherly://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.ratherly.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/ratherly` |
