...
| CI green on a self-hosted runner | ✅ | success — run 34975894955, 2026-09-15 |
...
| | State | Id |
|---|---|---|
| Bundle id registered | ✅ | `com.altixcode.ratherly` |
| App Store Connect record | ✅ | `6812380803` — store name "Ratherly" |
...
| AdMob app — iOS | ✅ | `ca-app-pub-2504845459806550~5134143227` |
| AdMob app — Android | ✅ | `ca-app-pub-2504845459806550~8348473236` |
| AdMob ad units (6) | ✅ | iOS banner/interstitial/rewarded `8195420835` / `9765496685` / `8452415011`; Android `1003326522` / `4337076033` / `6882339160` |
...
| RevenueCat project, apps, entitlement, offering | ✅ | project `proje96a8de8`, entitlement `entl6add2e2886`, offering `ofrng81ead5201d` |
