#!/usr/bin/env node
/**
 * Generates every brand asset for Ratherly from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"rect","x":0.06,"y":0.16,"w":0.38,"h":0.68,"r":0.09,"fill":"accent"},{"type":"rect","x":0.56,"y":0.16,"w":0.38,"h":0.68,"r":0.09,"fill":"accentMid"},{"type":"circle","cx":0.25,"cy":0.5,"r":0.085,"fill":"ink"},{"type":"path","points":[[0.65,0.42],[0.85,0.42]],"w":0.075,"fill":"ink"},{"type":"path","points":[[0.65,0.58],[0.85,0.58]],"w":0.075,"fill":"ink"}];
 ...
 */
const MARK = [[1,1,0.12,1,1],[1,1,0.12,1,1],[1,1,0.12,1,1],[1,1,0.12,0.45,0.45],[1,1,0.12,0.12,0.12]];
...
console.log('Generating Ratherly brand assets\n');
